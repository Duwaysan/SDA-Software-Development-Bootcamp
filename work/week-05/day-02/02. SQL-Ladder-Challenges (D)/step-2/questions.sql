...
-- SELECT e.*, d.Name ,d.Budget FROM Employees as e
-- JOIN Departments d ON e.Department = d.Code;
-- -- 2.11 Select the name and last name of each employee, along with the name and budget of the employee's department.
-- SELECT e.Name, e.LastName, d.Name AS DepartmentName, d.Budget FROM Employees e
-- JOIN Departments d ON e.Department = d.Code;
...
--                     ORDER BY budget ASC
--                     OFFSET 1 ROW
--                     FETCH NEXT 1 ROW ONLY); -- to select only one row
