...
students = ['Khalid','Abdulaziz','Saad','Ali']
def manage_students():
    # your code here
...
foods = ('Rice', 'Chicken','Meat','Vegetables')
def combine_foods():
    # your code here
    meal = ''
    for food in foods:
...
def hometown_info():
    # your code here
    return f"I was born in {home_town['country']}, {home_town['city']} - population of {home_town['population']}"
# Call the function and print the result
...
# Call the function and print the result
print('Exercise 7:', create_awesome_students())




# Exercise 8: Filter Foods
#
