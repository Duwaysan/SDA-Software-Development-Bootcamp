            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" value={formData.username} name="username" id="id_username" minLength="3" maxLength="150" onChange={handleChange} />
                            <br/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value={formData.email} name="email" id="id_email" minLength="3" maxLength="150" onChange={handleChange} />
                            <br/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="password" value={formData.password} name="password" id="id_password1" minLength="3" onChange={handleChange} />
                            <br/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="password" value={formData.confirmPassword} name="confirmPassword" id="id_password2" onChange={handleChange}/>
                            <br/>
